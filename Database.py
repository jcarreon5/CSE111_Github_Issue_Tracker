    ...
    try:
        commands = [
            ...
            """CREATE TABLE projectmanagers (
                ...
                UNIQUE (pm_developerID, pm_projectID)
            );""",
            """CREATE TABLE customers (
                ...
                FOREIGN KEY(c_industryID) REFERENCES industry(ind_industryID) ON DELETE SET NULL
            );""",
            ...
            """CREATE TABLE customerprojects (
                ...
                FOREIGN KEY(cp_customerID) REFERENCES customers(c_customerID) ON DELETE CASCADE,
                FOREIGN KEY(cp_projectID) REFERENCES projects(p_projectID) ON DELETE CASCADE,
...
def populateTables(_conn):
    ...
    try:
        ...
        for l in customerprojects:
            _conn.execute(sql, l)
            _conn.commit()

        sql = "INSERT INTO developerprojects VALUES(?, ?)"
        for l in developerprojects:
            _conn.execute(sql, l)
            _conn.commit()
